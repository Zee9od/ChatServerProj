...
enum MSG_IDS {
	...
	ID_ADD_FRIEND_REQ = 1009, //发送添加好友请求
	ID_ADD_FRIEND_RSP  = 1010, //发送添加好友回复
	ID_NOTIFY_ADD_FRIEND_REQ = 1011,  //通知用户添加好友请求
	ID_AUTH_FRIEND_REQ = 1013,  //认证好友请求
	ID_AUTH_FRIEND_RSP = 1014,  //认证好友回复
	ID_NOTIFY_AUTH_FRIEND_REQ = 1012, //通知用户认证好友请求(通知发送好友请求者的最终回复)
	ID_TEXT_CHAT_MSG_REQ = 1017, //文本聊天信息请求
	ID_TEXT_CHAT_MSG_RSP = 1018, //文本聊天信息回复
	ID_NOTIFY_TEXT_CHAT_MSG_REQ = 1019, //通知用户文本聊天信息
	ID_NOTIFY_OFF_LINE_REQ = 1021, //通知用户离线
	ID_HEART_BEAT_REQ = 1023,      //心跳检测
